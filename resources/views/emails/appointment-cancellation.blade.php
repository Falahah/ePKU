...
<body>
<div class="card-body">
    <?php if(session('cancellationDetails') && auth()->user()): ?>
        <?php
        ...
        <div class="StyledReceipt">
            <div class="header-title">
                <h2 class="text-primary">Appointment Cancellation Confirmation</h2>
                <hr>
            </div>
            <div class="header">
            ...
            <div class="receipt-details">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <?php echo e($cancellationDetails['appointment_id']); ?>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-sm-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <?php echo e($cancellationDetails['service']); ?>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-8">
                        <?php echo e(\Carbon\Carbon::parse($cancellationDetails['date'])->format('d/m/Y')); ?>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-sm-4">
            ...
            <hr style="border-top: 1px dashed #000;">
            <div class="footer">
                <p class="text-center"><strong>Your appointment has been successfully cancelled.</strong></p>
            </div>
        </div>
        <p class="text-center"><br>We're sorry that you have to cancel the appointment.</p>            
    <?php endif; ?>
</div>
</body>
</html>
