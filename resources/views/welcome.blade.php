...
<div class="container-top">
    <div>
        ...
        <div class="text-center">
            <div><br>
                <h3 class="text-primary"><strong>Welcome to e-Appointment System for UTHM Health Centre!</strong></h3>
            </div>
        </div>
        @else
        <div class="col-md-10 text-center mx-auto">
            <h3 class="text-primary"><strong>Welcome, {{ Auth::user()->name }}!</strong></h3><br>
        @endguest
        </div>
    </div>
</div>
    ...
    <div>
        ...
        <div class="col-md-10 text-center">
            <div class="mt-4 btn-group w-100 d-flex justify-content-center">
                <a href="{{ route('appointments.create') }}" class="btn btn-success btn-lg flex-fill">
                    <i class="fas fa-book"></i> Book Appointment</a>
                <a href="{{ route('profile') }}" class="btn btn-info btn-lg flex-fill ">
                    <i class="fas fa-user"></i> View Profile</a>
                <a href="{{ route('booking-history') }}" class="btn btn-primary btn-lg flex-fill ">
